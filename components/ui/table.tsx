...
export function THead({ className, ...props }: React.HTMLAttributes<HTMLTableSectionElement>) {
  return (
    <thead
      className={cn(
        "border-b border-border text-left text-xs uppercase tracking-wide text-text-muted font-mono",
        className,
      )}
      {...props}
    />
...
export function TD({ className, ...props }: React.TdHTMLAttributes<HTMLTableCellElement>) {
  return <td className={cn("px-3 py-2.5 align-middle text-text-secondary", className)} {...props} />;
}
